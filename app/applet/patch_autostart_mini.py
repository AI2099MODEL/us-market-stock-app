...
content = content.replace("val isEngineRunning = MutableStateFlow(false)", "val isEngineRunning = MutableStateFlow(true)")
...
if target_parse in ws_content:
    ...
    print("Target parse block not found in ShoonyaWebSocketManager!")
